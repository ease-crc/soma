...
In addition, a comment attached "Unknown Object: \cramentitytoreplace{CRAM-OBJECT-TYPE}" to this instance.
\cramentitytoreplace{CRAM-OBJECT-TYPE} indicates which object you need to define in the ontology.
