...
Unknown tasks, tasks which are not defined in the ontology, will be logged as \textit{PhysicalTask}.
The \textit{PlanExecution} instance pointing to the \textit{PhysicalTask} will have a comment attached with the statement "Unknown Action: \textless CRAM-ACTION-NAME\textgreater", where \textless CRAM-ACTION-NAME\textgreater" is the action name you defined in your plan.\todo{DB: Maybe add this annotation ?}
...
With this step you added successfully the support of the new action to the \cram \neem episodic memory logger.
