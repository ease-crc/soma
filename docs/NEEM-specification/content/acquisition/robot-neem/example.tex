\subsection{Example}
	...
	We will not go into the details about the \neemexp meaning the \tf \todo{Abhijit: "the tf" seems odd in middle of sentence} since we just stored the exact \tf message in the database.
	...
	You can also read from the log that the \pr2 tried already an transporting task on another object and that this task is also not the last transporting task.
	...
	It placed the object in the specific pose in the map which is displayed in \ref{fig:pose} \todo{Abhijit: missing Figure labels}.
