...
\todo{write about competency questions here. Probably would be good to provide a list of them that we intend to cover with the information contained in neems}
...
% % % % % % % % % % % % % % % % %
% % % % % % % % % % % % % % % % %
\subsection{Outline} % Domain of Discourse
