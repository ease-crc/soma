...
The entities that DL axioms describe can be either \emph{concepts} (sometimes known as \emph{classes}),
...
i.e. the relation asserts that Bob us a child of Alice.
We may also know the height of Allice, which would be represented by a data property \relation{hasHeight} whose value could be a string such as \emph{1,7m} to represent that she is 1.7m tall.
%%
