...
%In section \ref{sec:episodes}, we discuss contextualization concept which is useful to consider for social interactions.
%Such as robots performing successful navigation task but failing to consider situational context by ignoring fact that the path it took blocked someone's path.
