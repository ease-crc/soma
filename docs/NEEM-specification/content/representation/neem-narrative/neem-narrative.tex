...
The reason being that intentions of agents can not be observed directly, and hence an interpretation is required.
...
Finally, a state is defined as an event where an object has a dedicated stable configuration which is usually represented as having a certain property value over some time interval.
