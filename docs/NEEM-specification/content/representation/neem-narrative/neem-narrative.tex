...
In this case the fetching event contributes to multiple goals and would belong to different classes in an action taxonomy which is organized based on agentivity.
