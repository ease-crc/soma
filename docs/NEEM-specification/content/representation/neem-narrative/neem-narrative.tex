...
The story represented in the \neemnar provides context for events that occurred during an activitiy.
...
i.e., for more general or specific variants of a task.
