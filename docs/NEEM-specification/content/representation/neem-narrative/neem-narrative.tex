...
\begin{ODP}{Object Role}
	...
	\begin{tikzpicture}
	    ...
	    \draw (B) edge[relation] node[midway,label=right:isRoleOf] {} (A);
	\end{tikzpicture}
	}
	%% Example KnowRob language expressions
	\ODPEXAMPLES{
...
\begin{ODP}{Task Execution}
	...
	\begin{tikzpicture}
	    ...
	    \draw (B) edge[relation] node[midway,label=right:isExecutedIn] {} (A);
	\end{tikzpicture}
	}
	%% Example KnowRob language expressions
	\ODPEXAMPLES{
...
\begin{ODP}{??}
	...
	\ODPGRAPHIC{
	\begin{tikzpicture}
	    \node[owlclass] (A) {Process};
	    \node[owlclass,below=0.6cm of EVT] (B) {Process Type};
	    \draw (B) edge[relation]
	    	node[midway,label=right:isOccurringIn] {} (A);
	\end{tikzpicture}
	}
	%% Example KnowRob language expressions
	\ODPEXAMPLES{
...
\begin{ODP}{??}
	...
	\ODPGRAPHIC{
	\begin{tikzpicture}
	    \node[owlclass] (A) {State};
	    \node[owlclass,below=0.6cm of EVT] (B) {State Type};
	    \draw (B) edge[relation]
	    	node[midway,label=right:isOccurringIn] {} (A);
	\end{tikzpicture}
	}
