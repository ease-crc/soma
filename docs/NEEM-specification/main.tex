...
\begin{figure}
	\centering
	\includegraphics[width=0.55\columnwidth]{img/CommunicationTask_Taxonomy.png}
	\caption{Communication task taxonomy.}
	\label{fig:Taxonomy:communicationTask}
\end{figure}


\subsubsection{Mental Task}
Mental Task deals with mental related tasks.
\begin{figure}
	\centering
	\includegraphics[width=0.55\columnwidth]{img/MentalTask_Taxonomy.png}
	\caption{Mental task taxonomy.}
	\label{fig:Taxonomy:mentalTask}
\end{figure}


\subsubsection{Physical Task}
Physical Task deals with Physical related tasks.
\begin{figure}
	\centering
	\includegraphics[width=0.55\columnwidth]{img/PhysicalTask_Taxonomy.png}
	\caption{Physical task taxonomy.}
	\label{fig:Taxonomy:physicalTask}
\end{figure}
